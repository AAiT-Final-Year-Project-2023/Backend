...
export class ContributionController {
    ...
    @Get()
    async find(@Query('requestPostId', ParseIntPipe) requestPostId?: number){
        if(requestPostId)
            return this.contributionService.findRequestPostContributions(requestPostId);
    ...
    @Patch(':id')
    async update(@Param('id', ParseIntPipe) id: number, @Body() body: UpdateContributionDto){
